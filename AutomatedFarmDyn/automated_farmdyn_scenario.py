...
FarmDynDir = r'C:\schaefer_shang\Farmdyn_v2_Scenario_RedZone' # Replace this with your FarmDyn folder
IniFile = "dairydyn.ini"  # This should stay like this
XMLFile = "dairydyn_default.xml" # This should stay like this
BATCHDir = r'C:\schaefer_shang\Farmdyn_v2_Scenario_RedZone\GUI'  # Replace this with your FarmDyn GUI folder


# In the GUI file, there must be a bacth file in txt format. This file defines e.g. number of experiments
BATCHFile = "batch_RedZone_Scenario.txt" # Replace this with your batch file, which must be in the GUI folder!
...
def automate(max_pause):
    ...
    f = Path('C:/schaefer_shang/Farmdyn_v2_Scenario_RedZone/results/expFarms') # Only replace this with your FarmDyn folder until "/results/expFarms" 
    now = datetime.now()
    ...
    if distance > timedelta(minutes = max_pause): 
        ...
        # Parent Directories 
        parent_dir = r'C:\schaefer_shang\Farmdyn_v2_Scenario_RedZone\results\LinMeiResults_Scenario'  # Replace this with the folder to where you want to move the generated data 
        # Path 
