...
BATCHFile = "batch_RedZone_Baseline.txt" # Replace this with your batch file, which must be in the GUI folder!
...
def automate(max_pause):
    ...
    if distance > timedelta(minutes = max_pause): 
        ...
        # Parent Directories 
        parent_dir = r'C:\schaefer_shang\Farmdyn_v2_Scenario_RedZone\results\LinMeiResults_Baseline'  # Replace this with the folder to where you want to move the generated data
        # Path 
